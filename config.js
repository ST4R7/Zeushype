const ownerNumber = ["5514998435607@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5514998435607' 
...
const feio = 'Tu parece um sirgueijo, um caranguejo amassado 😡'
const bot = 'Me chamou onii-chan 👉👈?'
const fdp = 'Te foder rapaz, te deitar na porrada quando tiver dormindo'
const gostoso = 'Arigato go sai masu 😳👉👈'
const fofo = 'Arigato go sai masu 😳👉👈'
const baianor = 'Convidei sua placa-mãe pra minha rede seu corno'
const corno = 'Vai te foder, jogador de ff, comprador de pack do pézinho'
const puta = 'Senhora sua mãe 😡'
const gay = 'Falou o manja rola 😡'
const viado = 'Falou o manja rola 😡'
const numbotfeio = 'senhora sua mãe 😡'
// KEYS

const apiTobz = 'key'
// pra pegar a key do Tobz va até o numero 
//wa.me/5514998435607 se registre no bot
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5514998435607:+55 14 99843-5607\n' 
+ 'END:VCARD'
